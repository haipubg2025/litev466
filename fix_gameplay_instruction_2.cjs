...
const targetToRemove = `1. <json_update>...</json_update>
...
</json_MC>: Cập nhật thời gian, thời tiết, vị trí, NPC...`;

content = content.replace(targetToRemove, '1. <json_update>...</json_update>: Cập nhật thời gian, thời tiết, vị trí, NPC, tạo NPC mới...');

fs.writeFileSync('src/utils/gameplaySystemInstruction.ts', content);
console.log("Fixed gameplaySystemInstruction.ts step 2");
