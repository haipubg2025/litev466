...
export const COLOR_CATEGORIES = [
  ...
  { id: 'mau', label: 'Máu / Thương tích', desc: 'Máu me, cuồng nộ, sát khí, vết thương (VD: Giọt máu, Vết chém, Sát khí cuồn cuộn)' },
  { id: 'damThuy', label: 'Dâm thủy / Dâm dịch / Dịch sinh lý', desc: 'Dâm thủy, dâm dịch, tinh dịch, tình dịch, dịch âm đạo, nước dâm (VD: Dâm thủy tuôn trào, Dâm dịch ướt đẫm, Tinh dịch, Tình dịch)' },
